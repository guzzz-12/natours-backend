...
var signup = function signup(username, email, password, passwordConfirm) {
  (0, _axios.default)({
    method: "POST",
...
var renderMap = function renderMap(locations) {
  ...
  locations.forEach(function (location) {
    ...
    el.className = "marker"; //Agregar los marcadores al mapa

    new mapboxgl.Marker({
      element: el,
      anchor: "bottom"
    }).setLngLat(location.coordinates).addTo(map); //Agregar popup con la ubicación a los markers

    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(location.coordinates).setHTML("<p>Day ".concat(location.day, ": ").concat(location.description, "</p>")).addTo(map); //Extender el área del mapa a las coordenadas especificadas
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(tourId, userId, event) {
    var stripe, session, user, userBookings, toursBookedIds;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe("pk_test_UOKLVh6kbRl4QJDri8Cd27iA00WBmWgp06");
            _context.prev = 1;
            _context.next = 4;
          ...
          case 4:
            ...
            _context.next = 7;
            return (0, _axios.default)("/api/v1/users/".concat(userId));

          case 7:
            user = _context.sent;
            userBookings = user.data.data.data.bookings;
            toursBookedIds = [];

            if (userBookings.length > 0) {
              userBookings.forEach(function (el) {
            ...
            (0, _alerts.showAlert)("error", "You already booked this tour");
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(userId, tourId, review, rating) {
    var checkReview, reviews, reviewsUsersIds;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("/api/v1/tours/".concat(tourId, "/reviews"));
          ...
          case 3:
            ...
            (0, _alerts.showAlert)("error", "You can't add multiple reviews to the same tour.");
            setTimeout(function () {
              window.history.back();
            }, 3500);
            return _context.abrupt("return");
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"disableAccount.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.disableAccount = void 0;
...
var disableConfirmModal = document.querySelector(".disable-account-modal-container");
var cancelBtn = document.querySelector(".disableAccount--cancel");

var confirmDisable = function confirmDisable(providedPassword) {
  ...
  (0, _axios.default)({
    ...
    document.cookie = "jwt" + '=;expires=Thu, 01 Jan 1970 00:00:01 GMT;'; //Ocultar el modal

    disableConfirmModal.classList.add("disable-account-modal-container--hidden"); //Mostrar la notificación al deshabilitar la cuenta

    (0, _alerts.showAlert)("success", "Your account was successfully disabled"); //Redirigir al home
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(providedPassword) {
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            //Mostrar el modal de confirmación
            disableConfirmModal.classList.remove("disable-account-modal-container--hidden"); //Confirmar desactivación de la cuenta

            document.querySelector(".disableAccount").addEventListener("click", function () {
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"sendPasswordResetEmail.js":[function(require,module,exports) {
"use strict";
...
var sendForgotPasswordEmail = function sendForgotPasswordEmail(email) {
  (0, _axios.default)({
    ...
    if (res.data.status === "success") {
      (0, _alerts.showAlert)("success", "Email sent! Check your inbox.");
    }
  }).catch(function (err) {
    (0, _alerts.showAlert)("error", err.response.data.message);
  });
...
var resetPassword = function resetPassword(password, passwordConfirm, token) {
  (0, _axios.default)({
    method: "PATCH",
    ...
    if (res.data.status === "success") {
      (0, _alerts.showAlert)("success", "Password successfully updated.");
      location.assign("/");
    }
  }).catch(function (err) {
    (0, _alerts.showAlert)("error", err.response.data.message);
...
var _disableAccount = require("./disableAccount");
...
var disableAccountForm = document.querySelector(".form-user-disable");
var forgotPasswordForm = document.querySelector("#form--forgot-password");
var resetPasswordForm = document.querySelector("#form--reset-password"); //Mostrar el mapa
...
if (bookBtn) {
  bookBtn.addEventListener("click", function (e) {
    ...
    (0, _stripe.bookTour)(tourId, userId, e);
  });
} //Agregar review
...
if (reviewForm) {
  reviewForm.addEventListener("submit", function (e) {
    e.preventDefault();
    var reviewText = document.querySelector("#review").value;
    var reviewRating = reviewForm.elements["rating"].value;
    var userId = e.target.dataset.reviewUser;
    var tourId = e.target.dataset.reviewTour;
    (0, _createReview.addReview)(userId, tourId, reviewText, reviewRating);
  });
} //Desactivar cuenta de usuario


if (disableAccountForm) {
  disableAccountForm.addEventListener("submit", function (e) {
    e.preventDefault();
    var providedPassword = disableAccountForm.elements["password-disable"].value;
    (0, _disableAccount.disableAccount)(providedPassword);
  });
...
if (forgotPasswordForm) {
  forgotPasswordForm.addEventListener("submit", function (e) {
    e.preventDefault();
    var email = document.querySelector("#forgot-password-email").value;
    console.log(email);
    (0, _sendPasswordResetEmail.sendForgotPasswordEmail)(email);
  });
