      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            (0, _alerts.showAlert)("error", "You can't add multiple reviews. Redirecting...");
            setTimeout(function () {
              window.history.back();
            }, 3500);
            return _context.abrupt("return");
...
var reviewForm = document.getElementById("form--review"); //Mostrar el mapa
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "48432" + '/');
